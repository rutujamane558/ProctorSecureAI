...
quiz_data = [
    {"question": "What is the default value of an int variable in C++?", "options": ["0", "null", "undefined", "1"], "answer": "0"},
    {"question": "Which of the following is used to define a constant in C++?", "options": ["const", "constant", "final", "static"], "answer": "const"},
    {"question": "What is the size of an int in C++?", "options": ["32 bits", "64 bits", "16 bits", "8 bits"], "answer": "32 bits"},
    {"question": "Which of these is the correct way to create a class in C++?", "options": ["class MyClass { };", "class MyClass; {}", "class { MyClass };", "None of the above"], "answer": "class MyClass { };"},
    {"question": "Which of these methods is used to start a thread in C++?", "options": ["run()", "start()", "create()", "begin()"], "answer": "start()"},
    {"question": "Which of the following is used for input in C++?", "options": ["cin", "scanf", "getchar", "All of the above"], "answer": "All of the above"},
    {"question": "Which of the following is the correct way to define a function in C++?", "options": ["void function_name()", "function_name void()", "public void function_name()", "void function_name() {}"], "answer": "void function_name() {}"},
    {"question": "Which of these is not a valid data type in C++?", "options": ["int", "double", "string", "boolean"], "answer": "string"},
    {"question": "Which of the following is the base class for all exceptions in C++?", "options": ["Exception", "Throwable", "Error", "RuntimeException"], "answer": "Exception"},
    {"question": "Which of these is not an access modifier in C++?", "options": ["public", "private", "protected", "secure"], "answer": "secure"}
]
